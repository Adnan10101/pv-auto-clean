...
func (r *PersistentVolumeReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	//l.Info("Reconciled PV", "Name", pv.Name, "Namespace", pv.Namespace)
	switch pv.Status.Phase {

	// case corev1.VolumeAvailable:
	// 	l.Info("Volume Available PV", "Name", pv.Name, "Namespace", pv.Namespace)

	case corev1.VolumeFailed, corev1.VolumeReleased:
		l.Info("Volume Failed/Released PV", "Name", pv.Name, "Namespace", pv.Namespace)
		if pv.Spec.ClaimRef != nil {
			pv.Spec.ClaimRef = nil
		}
		if err := r.Update(ctx, pv); err != nil {
			l.Error(err, "Failed to update PV", "Name", pv.Name)
			return ctrl.Result{}, err
		}
		l.Info("Successfully updated PV", "Name", pv.Name, "Namespace", pv.Namespace)
